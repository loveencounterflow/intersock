  ...
  this.Intersock_server = Intersock_server = class Intersock_server extends Intersock {
    ...
    serve() {
      ...
      this._ws_server.on('connection', connection = (ws) => {
        ...
        //.....................................................................................................
        log(`^${this.cfg._$from}/on_connection@1^ Intersock WebSocketServer connected on ${this.cfg.url}`);
        this.send('info', `helo from ${this.cfg.url}`);
        return null;
      });
      //.......................................................................................................
      log(`^${this.cfg._$from}/serve@1^ Intersock WebSocketServer listening on ${this.cfg.url}`);
      return null;
    }
