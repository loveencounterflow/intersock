  ...
  this.Intersock_client = Intersock_client = class Intersock_client extends Intersock {
    ...
    start() {
      ...
      this.on('message', (data_ui8a) => {
        var message;
        debug('^Intersock_client.on/message@1^', this.constructor.name, typeof data_ui8a, Object.prototype.toString.call(data_ui8a));
        message = this._parse_message(data_ui8a);
