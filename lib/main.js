(function() {
  ...
  get_message_class = function(hub) {
    ...
    //---------------------------------------------------------------------------------------------------------
    $idx = -1;
    $from = hub instanceof Intersock_server ? 's' : 'c';
    //---------------------------------------------------------------------------------------------------------
    ...
    serve() {
      ...
      this._ws_server.on('connection', connection = (ws) => {
        ...
        this._ws.on('message', (d) => {
          ...
          if (d.$key !== 'received') {
            ws.send(JSON.stringify(new this.Message('received', d)));
          }
          return null;
        });
        //.....................................................................................................
    ...
    connect() {
      return new Promise((resolve, reject) => {
        ...
        this.on('open', () => {
          ...
          this._ws_client.send(JSON.stringify(new this.Message('info', "helo from client")));
          return resolve(null);
        });
        //.......................................................................................................
